...
//
// ### function _cvtsd2si (size, dst, src)
// #### @size {Number} Either 32 or 64
...
// in MXCSR.
//
Asm.prototype._cvtsd2si = function _cvtsd2si(size, dst, src) {
  this.emitb(size === 64 ? 0xf2 : 0xf3);
  this.rexw(dst, src, false, !Array.isArray(src));
  this.emitb(0x0f);
  this.emitb(0x2d);
...
Asm.prototype.cvtsd2si = function cvtsd2si(dst, src) {
  return this._cvtsd2si(64, dst, src);
};
...
Asm.prototype.cvtss2si = function cvtss2si(dst, src) {
  return this._cvtsd2si(32, dst, src);
};

//
// ### function _cvttsi2sd (size, dst, src)
// #### @size {Number} Either 32 or 64
// #### @dst {String|Array} General purpose register or memory address
// #### @src {String} Xmm register
...
//
Asm.prototype._cvttsd2si = function _cvttsi2sd(size, dst, src) {
  this.emitb(size === 64 ? 0xf2 : 0xf3);
  this.rexw(dst, src, false, !Array.isArray(src));
  this.emitb(0x0f);
  this.emitb(0x2c);
...
Asm.prototype.cvttsd2si = function cvttsd2si(dst, src) {
  this._cvttsd2si(64, dst, src);
};

//
// ### function cvttsi2ss (dst, src)
// #### @dst {String|Array} General purpose register or memory address
// #### @src {String} Xmm register
// Emit `cvttss2si`.
...
Asm.prototype.cvttss2si = function cvttss2si(dst, src) {
  this._cvttsd2si(32, dst, src);
};

//
// ### function _cvtsi2sd (size, dst, src)
// #### @size {Number} Either 32 or 64
// #### @dst {String|Array} Xmm register or memory address
...
//
Asm.prototype._cvtsi2sd = function _cvtsi2sd(size, dst, src) {
  this.emitb(size === 64 ? 0xf2 : 0xf3);
...
Asm.prototype.cvtsi2sd = function cvtsi2sd(dst, src) {
  return this._cvtsi2sd(64, dst, src);
};
...
Asm.prototype.cvtsi2ss = function cvtsi2ss(dst, src) {
  return this._cvtsi2sd(32, dst, src);
};
