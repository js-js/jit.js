...
//
Asm.prototype.pcmpeqd = function pcmpeqd(dst, src) {
  this.optrex(64, dst, src, true, true);
  this.emitb(0x66);
  this.emitb(0x0f);
  this.emitb(0x76);
  this.modrm(dst, src, true, true);
...
//
Asm.prototype.xorpd = function xorpd(dst, src) {
  this.optrex(64, dst, src, true, true);
  this.emitb(0x66);
  this.emitb(0x0f);
  this.emitb(0x57);
...
// Bit-wise exclusive-or
//
Asm.prototype.andpd = function andpd(dst, src) {
  this.optrex(64, dst, src, true, true);
  this.emitb(0x66);
  this.emitb(0x0f);
  this.emitb(0x54);
