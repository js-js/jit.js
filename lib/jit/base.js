...
BaseMasm.prototype._allocate = function allocate(n) {
  if (this._current) {
...
BaseMasm.prototype.emitb = function emitb(byte) {
  if (this._left < 1) this._allocate(1);
...
BaseMasm.prototype.emitw = function emitw(word) {
  if (this._left < 2) this._allocate(2);
...
BaseMasm.prototype.emitq = function emitq(buf) {
...
BaseMasm.prototype.toBuffer = function toBuffer() {
